...
@section('content')
    <div class="container">
        <div class="m-3">
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight " style="font-size: 1.5rem">Trạng thái đơn hàng
                </h2>
            </div>
            <hr class="m-4">
            <div class="items">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight " style="font-size: 1.5rem">Sản phẩm trong đơn hàng
                </h2>
                    ...
                    <tbody>
                        @foreach ($order->orderItems as $item)
                            <tr>
                                ...
                                <td><img src="{{ asset('images/products/' . $item->product->image_path) }}"
            ...
            <div class="order-total flex justify-end">
                <h2 class="text-xl text-gray-800 leading-tight">
                    <strong>Tổng giá:</strong> {{ number_format($order->amount, 2) }} VND
                </h2>
            </div>
            
        </div>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Cập nhật trạng thái</h2>
